...
def load_flist(flist):
        ...
        if isinstance(flist, str):
            if os.path.isdir(flist):
                flist = list(glob.glob(flist + '/*.jpg')) + list(glob.glob(flist + '/*.png'))+list(glob(path_true + '/*.JPEG')) +list(glob(path_true + '/*.JPG'))
                flist.sort()
                return flist
...
files = list(glob(path_true + '/*.jpg')) + list(glob(path_true + '/*.png'))+list(glob(path_true + '/*.JPEG')) +list(glob(path_true + '/*.JPG'))
